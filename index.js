...
async function sendCombinedReport() {
    ...
    try {
        ...
        const ticketData = `
<b>• Ticket - Unclosed:</b> ${unclosedResponse.data.data[0].count_id}
<b>• Ticket - Open In SLA</b>: ${openInSLAResponse.data.data[0].count_id}
<b>• Ticket - Open Out SLA</b>: ${openOutSLAResponse.data.data[0].count_id}
`;
...
<b>• Ticket - Closed</b>: ${closedResponse.data.data[0].count_id}
<b>• Ticket - Closed In SLA</b>: ${closedInSLAResponse.data.data[0].count_id}
<b>• Ticket - Closed Out SLA</b>: ${closedOutSLAResponse.data.data[0].count_id}
`;
...
async function top3DetailsReport() {
    ...
    try {
        ...
        let top3Report = `
-------------------------------
<b>Aging cluster for ticket open out of SLA
${reportDateRange}</b>
-------------------------------
`;
